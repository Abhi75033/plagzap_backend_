    ...
    io.on('connection', (socket) => {
        ...
        socket.on('join-meeting', async ({ meetingCode }) => {
            try {
                ...
                meetings.get(meetingCode).set(socket.id, {
                    socketId: socket.id,
